...
/// Stub trait replacing pulsar_lsp::traits::DefinitionProvider (not available in installer build)
pub trait DefinitionProvider: 'static {
    fn definitions(
        ...
        cx: &mut gpui::Context<crate::input::InputState>,
    ) -> gpui::Task<anyhow::Result<Vec<lsp_types::LocationLink>>>;
}
